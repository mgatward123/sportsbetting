...
df = pd.read_csv('leaguetwo2020.csv')
#moredata = pd.read_csv('leagueone2019.csv')
...
new_fixtures = pd.DataFrame( [['Cambridge','Bradford','D',0,0,0,0,0,0],
                             ['Cheltenham','Leyton Orient','D',0,0,0,0,0,0],
                             ['Crawley Town','Carlisle','D',0,0,0,0,0,0],
                             ['Grimsby','Morecambe','D',0,0,0,0,0,0],
                             ['Macclesfield','Exeter','D',0,0,0,0,0,0],
                             ['Mansfield','Newport County','D',0,0,0,0,0,0],
                             ['Oldham','Forest Green','D',0,0,0,0,0,0],
                             ['Plymouth','Crewe','D',0,0,0,0,0,0],
                             ['Port Vale','Colchester','D',0,0,0,0,0,0],
                             ['Stevenage','Salford','D',0,0,0,0,0,0]],columns=feat_table.columns)
