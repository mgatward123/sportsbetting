...
df = pd.read_csv('ligue12020.csv')
#moredata = pd.read_csv('scottish2018.csv')
...
new_fixtures = pd.DataFrame( [['Amiens','Paris SG','D',0,0,0,0,0,0],
                             ['Bordeaux','Dijon','D',0,0,0,0,0,0],
                             ['Nantes','Metz','D',0,0,0,0,0,0],
                             ['Nimes','Angers','D',0,0,0,0,0,0],
                             ['Toulouse','Nice','D',0,0,0,0,0,0]],columns=feat_table.columns)
