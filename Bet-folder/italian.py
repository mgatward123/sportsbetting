...
df = pd.read_csv('italian2020.csv')
...
new_fixtures = pd.DataFrame( [['Juventus','Brescia','D',0,0,0,0,0,0],
                             ['Sampdoria','Fiorentina','D',0,0,0,0,0,0],
                             ['Sassuolo','Parma','D',0,0,0,0,0,0],
                             ['Cagliari','Napoli','D',0,0,0,0,0,0],
                             ['Lazio','Inter','D',0,0,0,0,0,0],
