...
df = pd.read_csv('championship2020.csv')
#moredata = pd.read_csv('championship2019.csv')
...
new_fixtures = pd.DataFrame( [['Birmingham','Brentford','D',0,0,0,0,0,0],
                             ['Cardiff','Wigan','D',0,0,0,0,0,0],
                             ['Charlton','Blackburn','D',0,0,0,0,0,0],
                             ['Derby','Huddersfield','D',0,0,0,0,0,0],
                             ['Fulham','Barnsley','D',0,0,0,0,0,0],
                             ['Leeds','Bristol City','D',0,0,0,0,0,0],
                             ['Middlesbrough','Luton','D',0,0,0,0,0,0],
                             ['Preston','Millwall','D',0,0,0,0,0,0],
                             ['QPR','Stoke','D',0,0,0,0,0,0],
                             ['Sheffield Weds','Reading','D',0,0,0,0,0,0]],columns=feat_table.columns)
