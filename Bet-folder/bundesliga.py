...
df = pd.read_csv('bundesliga2020.csv')
...
new_fixtures = pd.DataFrame( [['Union Berlin','Leverkusen','D',0,0,0,0,0,0],
                             ['Augsburg','Freiburg','D',0,0,0,0,0,0],
                             ['RB Leipzig','Werder Bremen','D',0,0,0,0,0,0],
                             ['Paderborn','Hertha','D',0,0,0,0,0,0],
                             ['Hoffenheim','Wolfsburg','D',0,0,0,0,0,0],
                             ['Fortuna Dusseldorf','Wolfsburg','D',0,0,0,0,0,0],
